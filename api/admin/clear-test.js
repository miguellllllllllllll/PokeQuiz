...
// One-shot: remove "Miguel" entries from puzzle-game leaderboards that were
// added during diagnostics. Quiz leaderboard is NOT touched.
const TARGET_NAME = 'Miguel';
const KEYS = [
