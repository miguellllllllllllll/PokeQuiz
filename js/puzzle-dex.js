(function () {
	...
	function init() {
		...
		function postLeaderboard() {
			...
			try { fetch('/api/leaderboard', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ game: 'dex', name, score: streak, mode, playerId: pid }) }).catch(() => {}); } catch {}
		}
