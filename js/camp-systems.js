...
(function () {
	...
	// Map/tile constants and mart prices (now in CAMP_DATA)
	const TILE               = (window.CAMP_DATA || {}).TILE || 16;
	const MAP_W              = (window.CAMP_DATA || {}).MAP_W || 40;
	const MAP_H              = (window.CAMP_DATA || {}).MAP_H || 30;
	const GROW_MS            = (window.CAMP_DATA || {}).GROW_MS || 30000;
	const SEED_PRICE         = (window.CAMP_DATA || {}).SEED_PRICE || 5;
	const BERRY_PRICE        = (window.CAMP_DATA || {}).BERRY_PRICE || 10;
	const SCYTHE_PRICE       = (window.CAMP_DATA || {}).SCYTHE_PRICE || 75;
	const SCYTHE_RADIUS      = (window.CAMP_DATA || {}).SCYTHE_RADIUS || 3;
	const STONE_PRICE        = (window.CAMP_DATA || {}).STONE_PRICE || 50;
	const FRIENDSHIP_PER_BERRY = (window.CAMP_DATA || {}).FRIENDSHIP_PER_BERRY || 20;
