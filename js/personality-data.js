/* ============================================================
   personality-data.js  v2
   Three personality quizzes:
     kanto   — Which Kanto Pokémon Are You?   (12 results, 12 q)
     starter — Which Starter Are You?         ( 9 results, 10 q)
     type    — Which Pokémon Type Are You?    (10 results, 10 q)
   ============================================================ */
window.PERSONALITY_DATA = {
  ...
  quizzes: {
    ...
    /* ════════════════════════════════════════════
       QUIZ 1 – Which Kanto Pokémon Are You?
    ════════════════════════════════════════════ */
    kanto: {
      id: 'kanto',
      ...
      pokemon: {
        pikachu:    { id: 25,  name: 'Pikachu',    type: 'Electric', color: '#F7B731',
        ...
        charizard:  { id: 6,   name: 'Charizard',  type: 'Fire',     color: '#E84118',
        ...
        bulbasaur:  { id: 1,   name: 'Bulbasaur',  type: 'Grass',    color: '#4CD137',
        ...
        squirtle:   { id: 7,   name: 'Squirtle',   type: 'Water',    color: '#0097e6',
        ...
        eevee:      { id: 133, name: 'Eevee',       type: 'Normal',   color: '#8c7ae6',
        ...
        snorlax:    { id: 143, name: 'Snorlax',     type: 'Normal',   color: '#718093',
        ...
        gengar:     { id: 94,  name: 'Gengar',      type: 'Ghost',    color: '#8e44ad',
        ...
        mewtwo:     { id: 150, name: 'Mewtwo',      type: 'Psychic',  color: '#9B59B6',
                      traits: ['Analytical','Independent','Powerful','Complex'],
                      desc: "You operate on a different frequency. Intensely self-aware and endlessly analytical, you question everything and forge your own path — and that rare depth sets you apart from almost everyone." },
        jigglypuff: { id: 39,  name: 'Jigglypuff',  type: 'Fairy',    color: '#fd79a8',
                      traits: ['Expressive','Creative','Sensitive','Bold'],
                      desc: "You have a big personality and you're not afraid to use it. Deeply creative and emotionally tuned in, you feel everything fully — and when you share that with the world, people cannot look away." },
        lapras:     { id: 131, name: 'Lapras',       type: 'Water',    color: '#00b3cc',
        ...
        alakazam:   { id: 65,  name: 'Alakazam',    type: 'Psychic',  color: '#e1b12c',
        ...
        machamp:    { id: 68,  name: 'Machamp',     type: 'Fighting', color: '#c0392b',
    ...
    /* ════════════════════════════════════════════
       QUIZ 2 – Which Starter Pokémon Are You?
    ════════════════════════════════════════════ */
    starter: {
      id: 'starter',
      ...
      desc: 'Grass, Fire, or Water? Discover which of the 9 classic starters matches your soul.',

      pokemon: {
        bulbasaur:  { id: 1,   name: 'Bulbasaur',  type: 'Grass',  color: '#00b894',
                      traits: ['Reliable','Calm','Nurturing','Steady'],
                      desc: "The underrated choice that always delivers. You don't need the spotlight — your steady, patient presence is what keeps everything together. People who pick you never regret it." },
        charmander: { id: 4,   name: 'Charmander', type: 'Fire',   color: '#e17055',
        ...
        squirtle:   { id: 7,   name: 'Squirtle',   type: 'Water',  color: '#0984e3',
        ...
        chikorita:  { id: 152, name: 'Chikorita',  type: 'Grass',  color: '#55efc4',
        ...
        cyndaquil:  { id: 155, name: 'Cyndaquil',  type: 'Fire',   color: '#fdcb6e',
        ...
        totodile:   { id: 158, name: 'Totodile',   type: 'Water',  color: '#74b9ff',
        ...
        treecko:    { id: 252, name: 'Treecko',    type: 'Grass',  color: '#00b894',
        ...
        torchic:    { id: 255, name: 'Torchic',    type: 'Fire',   color: '#e84393',
                      traits: ['Spirited','Affectionate','Fierce','Confident'],
                      desc: "Small but absolutely unstoppable. Endlessly spirited and surprisingly fierce, you throw everything you have into everything you do — and the people who love you are never surprised when you win." },
        mudkip:     { id: 258, name: 'Mudkip',     type: 'Water',  color: '#6c5ce7',
      ...
      questions: [
        ...
        { text: "Where do you feel most at home?",
          answers: [
            ...
            { emoji:'🌊', text: "Near water — the ocean, a lake, a river",      weights: { squirtle:3, totodile:2, mudkip:2 } },
        ...
        { text: "A rival shows up looking for a battle. You...",
          answers: [
            ...
            { emoji:'🤔', text: "Study them first and wait for the right moment",weights: { treecko:3, squirtle:2, bulbasaur:1 } },
        ...
        { text: "What's your approach to a new challenge?",
          answers: [
            ...
            { emoji:'🌱', text: "Start slow, build momentum, then commit fully",weights: { chikorita:3, mudkip:2, cyndaquil:1 } },
            { emoji:'😎', text: "Walk in looking like I've done this a hundred times",weights: { treecko:3, squirtle:2, charmander:1 } }
          ]
        },
    ...
    /* ════════════════════════════════════════════
       QUIZ 3 – Which Pokémon Type Are You?
    ════════════════════════════════════════════ */
    type: {
      id: 'type',
      ...
      desc: 'Fire, Water, Psychic, Ghost… which of the 10 core types fits your personality?',

      pokemon: {
        fire:     { id: 6,   name: 'Fire Type',     type: 'Fire',     color: '#e17055', icon: '🔥',
                    typeName: 'Fire',
        ...
        water:    { id: 9,   name: 'Water Type',    type: 'Water',    color: '#0984e3', icon: '🌊',
                    typeName: 'Water',
        ...
        grass:    { id: 3,   name: 'Grass Type',    type: 'Grass',    color: '#00b894', icon: '🌿',
                    typeName: 'Grass',
                    traits: ['Nurturing','Patient','Steady','Grounded'],
                    desc: "Rooted, steady, and full of quiet life. You take your time, but you always grow toward the light. The most reliable person in any room — and the one who makes sure everyone else is okay before checking on yourself." },
        electric: { id: 26,  name: 'Electric Type', type: 'Electric', color: '#fdcb6e', icon: '⚡',
                    typeName: 'Electric',
                    traits: ['Energetic','Quick','Charismatic','Sharp'],
                    desc: "You charge every room you enter. Quick-witted, charismatic, and endlessly energetic — you process the world faster than almost anyone else, and you've got the sparkling personality to match." },
        psychic:  { id: 65,  name: 'Psychic Type',  type: 'Psychic',  color: '#a29bfe', icon: '🔮',
                    typeName: 'Psychic',
        ...
        ghost:    { id: 94,  name: 'Ghost Type',    type: 'Ghost',    color: '#6c5ce7', icon: '👻',
                    typeName: 'Ghost',
        ...
        dragon:   { id: 149, name: 'Dragon Type',   type: 'Dragon',   color: '#00cec9', icon: '🐉',
                    typeName: 'Dragon',
        ...
        fighting: { id: 68,  name: 'Fighting Type', type: 'Fighting', color: '#d63031', icon: '🥊',
                    typeName: 'Fighting',
        ...
        normal:   { id: 143, name: 'Normal Type',   type: 'Normal',   color: '#b2bec3', icon: '⭐',
                    typeName: 'Normal',
        ...
        ice:      { id: 131, name: 'Ice Type',      type: 'Ice',      color: '#74b9ff', icon: '❄️',
                    typeName: 'Ice',
                    traits: ['Cool','Composed','Precise','Rare'],
                    desc: "Elegant and crystalline under pressure. Cool on the outside, startling depths on the inside — you don't show your whole self to just anyone, but when you do, people discover something completely beautiful." }
      },
      ...
      questions: [
        ...
        { text: "How would you describe your sense of humour?",
          answers: [
            { emoji:'😂', text: "Loud and obvious — if it's funny, you show it",weights: { fire:3, electric:2, fighting:1 } },
            { emoji:'😏', text: "Dry and deadpan — people aren't sure if you're joking",weights: { ice:3, ghost:2, normal:1 } },
        ...
        { text: "Finally — what do you want people to feel when they're around you?",
          answers: [
            ...
            { emoji:'🥶', text: "Intrigued — like they've only seen a fraction of you",weights: { ice:3, psychic:2, ghost:1 } }
          ]
        }
      ]
    }
